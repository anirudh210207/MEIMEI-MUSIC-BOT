...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "ᴍᴇɪ ᴍᴇɪ")
OWNER_ID = list(map(int, getenv("OWNER_ID", "7191023456").split()))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/shadowbot_support")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/shadow_supportt")
...
LOG_FILE_NAME = "satorugojo.txt"
############################


# All Images Of 𝙼ι𝖊 𝙼ι𝖊°• // @gojo_jii @shadowgrouup
START_IMG_URL = getenv("START_IMG_URL", f"https://unitedcamps.in/Images/file_5011.jpg")
